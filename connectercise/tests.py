...
class ModelTests(TestCase):
    ...
    # Tests the Models' __str__() method
...
class PopulationScriptTests(TestCase):
    ...
    # Tests if Sports are successfully created
    ...
    # Tests if Requests are successfully created
    ...
    # Verifies all properties of Sport Requests
